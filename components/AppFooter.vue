...
<template>
  <footer class="bg-gray-900 text-white py-8 sm:py-12">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
        <div class="col-span-1 sm:col-span-2">
          <div class="flex items-center gap-3 mb-4">
            ...
            <span class="text-xl font-bold">vectorify</span>
          </div>
          <p class="text-gray-400 mb-4 max-w-md">
            Векторные иллюстрации под ваш стиль — быстро и без дизайнера. 
            Настраиваемые SVG для сайта, приложений и рекламы.
          </p>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2 text-gray-400">
            ...
            <li><a href="#" class="hover:text-white transition-colors">Тарифы</a></li>
            <li><a href="#" class="hover:text-white transition-colors">API</a></li>
            <li><a href="#" class="hover:text-white transition-colors">Интеграции</a></li>
          </ul>
        </div>
      ...
      <div class="border-t border-gray-800 mt-6 sm:mt-8 pt-6 sm:pt-8 flex flex-col sm:flex-row justify-between items-center">
        <p class="text-gray-400 text-sm">
          © 2024 Vectorify. Все права защищены.
        </p>
